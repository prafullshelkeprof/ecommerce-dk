  ...
  if (items.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-6 text-center py-20">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#1a1a1a]">{t("emptyTitle")}</h1>
      ...
      <div className="container-dk py-10">
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="text-gray-500 text-lg">
            {t("itemCount", { count: items.reduce((s, i) => s + i.quantity, 0) })}
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 sticky top-24">
              <h2 className="font-bold text-lg text-[#1a1a1a] mb-5">{t("summaryTitle")}</h2>
              ...
              <div className="mt-4 flex items-center justify-center gap-2">
                <span className="text-xs text-gray-400">{t("payWith")}</span>
