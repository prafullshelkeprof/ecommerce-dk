    ...
    <div>
      ...
      <div className="container-dk py-4">
        <nav className="flex items-center gap-2 text-xs text-gray-500">
          <Link href="/" className="hover:text-[#1a1a1a]">{t("home")}</Link>
          <ChevronRight size={12} />
          <Link href="/products" className="hover:text-[#1a1a1a]">{t("products")}</Link>
          <ChevronRight size={12} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              {/* Rating — only shown if product has reviews */}
              {(product.rating ?? 0) > 0 && (
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold text-[#1a1a1a]">{t("quantity")}</p>
            ...
            <div className="flex gap-3">
              ...
              >
                {!product.inStock ? t("outOfStock") : adding ? t("adding") : t("addToCart")}
              </button>
              <button className="btn-secondary px-4 py-3.5" aria-label={t("addToWishlist")}>
                <Heart size={18} />
              </button>
            </div>
            ...
            <div className="space-y-3 pt-2 border-t border-gray-100">
              {[
                { icon: Truck, text: t("freeShippingInfo") },
                { icon: RotateCcw, text: t("returnsInfo") },
                { icon: Shield, text: t("secureInfo") },
              ].map(({ icon: Icon, text }) => (
      ...
      {relatedProducts.length > 0 && (
        <section className="bg-[#faf8f5] py-16">
          <div className="container-dk">
            <h2 className="text-2xl font-bold text-[#1a1a1a] mb-8">{t("relatedTitle")}</h2>
